...
client.connect()
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, latitude, longitude) VALUES('Cha','2278556982240503','Male','tab','Javascript','stockholm','', '2,3,', 'Tja!! I am cha. I can speak Javascript. if you speak Java, do not contact me', '59.934590000000006', '18.0664998');"))
