...
client.connect()
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('Vidar','2620851437927086','Male','Space','Javascript,Ruby,Typescript,Python','Sweden Stockholm','3,2', '2,3,' , 'Hi I am Vidar.' , '' , '59.334590000000006', '18.0664998');"))
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('Cha','2278556982240503','Male','tab','Javascript,Java,C#,SQL,PHP','stockholm','1,2', '2,3,', 'Tja!! I am cha. I can speak Javascript. if you speak Java, do not contact me', '', '59.934590000000006', '18.0664998');"))
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('Tajin','10156432651737078','Female','tab','Javascript,cshop,Cplus,SQL','stockholm','3,2', '2,3,', 'Tja!! I am Tajin.' , '', '59.994590000000006', '18.0664998');"))
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('André','1383518758','Male','tabs','Javascript,Java,Ruby,Swift','stockholm','1,2', '', 'I like happy people', '', '59.337973', '17.941545');"))
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('Olivia Ekman Sundin','1545205203','Female','tab','Java,SQL','stockholm','1,2', '2,3,', 'This is me!', '', '59.934590000000006', '18.0664998');"))
