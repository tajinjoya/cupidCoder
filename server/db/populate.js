...
client.connect()
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('Zachary','100000169226739','Male','Space','Python,Javascript,Java,cshop','stockholm','3,1,', '2,3,', 'im a big soft boy (pic is catfish soz)', '', '59.334548', '18.099134');"))//
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('Sahin Aslan','100001446027549','Male','tab','Java,cshop,Cplus','stockholm','1,', '2,3,', 'i love inside jokes, id love to be a part of it someday', '', '59.324381', '18.063533');"))
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, gitHub, latitude, longitude) VALUES('Johanssen','100038731051722','Female','Space','Ruby,Swift','stockholm','1,', '2,3,', 'Hello!', '', '59.317421', '18.031003');"))
    ...
    .then(()=> client.query("INSERT INTO messages(chatId, messages1) VALUES('1_4','Hello :3/ How are you???');"))
    .then(()=> client.query("INSERT INTO messages(chatId, messages1) VALUES('1_16','plz help me/ im loneeelyyy');"))
