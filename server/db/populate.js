...
client.connect()
    ...
    .then(()=> client.query("INSERT INTO users (id,  user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio) VALUES('1','Cha','Cha_fb','Male','tab','js','stockholm','', '', 'hi I am ');"))
    .then(()=> client.query("INSERT INTO users (id,  user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio) VALUES('2','Vidar','Vidar_fb','Female','Space','js','Nacka','', '', 'hi I am ');"))
