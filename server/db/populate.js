...
client.connect()
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, geoLocation) VALUES('Vidar','2620851437927086','Female','Space','Javascript','Sweden Stockholm',',', '2,3', 'Hi I am Vidar.', '59.334590000000006 18.0664998');"))
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, geoLocation) VALUES('Cha','2278556982240503','Male','tab','Javascript','stockholm','1', '', 'Tja!! I am cha. I can speak Javascript. if you speak Java, do not contact me', '59.934590000000006 18.0664998');"))
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, geoLocation) VALUES('Tajin','10156432651737078','Female','tab','Javascript','stockholm','', '', 'Tja!! I am Tajin.' , '59.994590000000006 18.0664998');"))
