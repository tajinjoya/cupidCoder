...
client.connect()
    ...
    .then(()=> client.query("INSERT INTO users (user_name,  facebook_id, Gender, tab,languages, user_location, pending_matches, matches, bio, geoLocation) VALUES('Vidar','2620851437927086','Female','Space','Javascript','Sweden Stockholm','', '', 'Hi I am Vidar.', '59.334590000000006 18.0664998');"))
